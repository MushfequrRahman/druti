                        ...
                        foreach ($ul as $row) { ?>
                          <tr>
                            ...
                            <?php if ($this->session->userdata('factoryid') == $row['dfactoryid'] && $row['status'] == 2) {
                              ...
                              //					  {
                            ?>
                              <td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/non_po_factory_challanm_receive_form/<?php echo $bn = $row['nonpochmid']; ?>"><?php echo $row['challanno']; ?></a></td>
                            <?php
                            } elseif ($this->session->userdata('factoryid') == $row['sfactoryid']) {
                            ?>
                              <td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/non_po_factory_challanm_sapproved/<?php echo $bn = $row['nonpochmid']; ?>"><?php echo $row['challanno']; ?></a></td>
                            <?php
                            } else {
                            ?>
                            ...
                            ?>
                            <td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/non_po_challanm_details/<?php echo $bn = $row['nonpochmid']; ?>">Details</a></td>
                          </tr>
                        <?php } ?>
                      </tbody>
                    </table>
