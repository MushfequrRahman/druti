            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['bqty']." ".$row['puom'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['abqty']." ".$row['puom'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['bdia'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['gsm'];?></td>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/color_wise_fabric_part_up/<?php echo $bn=$row['cwfpid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
                 </tr>
