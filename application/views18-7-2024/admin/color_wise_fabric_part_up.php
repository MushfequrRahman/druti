          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
				...
				{ ?>
                    <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/color_wise_fabric_part_lup" method="post" enctype="multipart/form-data">
                    <form role="form" name="insert_form" id="insert_form" autocomplete="off" method="post" enctype="multipart/form-data">
                    	<input type="hidden" class="form-control" name="cwfpid" value="<?php echo $row['cwfpid']; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="fabricpart" id="fabricpart">
                        	<option value="<?php echo $row['fabricpartid']; ?>"><?php echo $row['fabricpart']; ?></option>
                          <?php
                          foreach ($ul3 as $row1) {
                          ?>
                 ...
                 <div class="form-group">
					...
					<input type="text" class="form-control" name="bqty" value="<?php echo $row['bqty']; ?>">
                    <?php echo form_error('bqty', '<div class="error">', '</div>');  ?>
				</div>
                 <div class="form-group">
					<label>Additional Booking Qty</label>
					<input type="text" class="form-control" name="abqty" value="<?php echo $row['abqty']; ?>">
                    <?php echo form_error('abqty', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
					<label>Booking Dia</label>
					<input type="text" class="form-control" name="bdia" value="<?php echo $row['bdia']; ?>">
