              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Color Info Update</h3>
                    <div class="row">
				...
				{ ?>
                    <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/color_lup" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="cwoqty" value="<?php echo $row['cwoqty']; ?>">
                    <?php echo form_error('cwoqty', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
