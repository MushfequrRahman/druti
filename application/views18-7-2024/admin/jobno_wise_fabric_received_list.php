  ...
  <div class="text-right-input">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><?php echo $rem=number_format((float)$row['tfqty'], 2, '.', '');?></td>
				  ...
				  {
				  ?>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/fabric_delivery_form/<?php echo $row['fabricreceivedid'];?>/<?php echo number_format((float)$row['tfqty'], 2, '.', '');?>"><strong>Delivery</strong></a></td>
                  <?php
				  }
				  else
				  {
				  ...
				  {
				  ?>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/fabric_transfer_form/<?php echo $row['fabricreceivedid'];?>/<?php echo number_format((float)$row['tfqty'], 2, '.', '');?>"><strong>Transfer</strong></a></td>
                  <?php
				  }
				  else
				  {
